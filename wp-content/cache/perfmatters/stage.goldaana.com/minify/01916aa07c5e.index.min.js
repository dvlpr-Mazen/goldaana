...
function renderProductPrice(elements,livePrice_24,calculatedValue,color){elements.forEach((element)=>{const weight=parseFloat(element.getAttribute('data-product-weight'))||1;const manufacturingFees=parseFloat(element.getAttribute('data-product-manufacturing-fees'))||1;const goldCarat=parseInt(element.getAttribute('data-product-gold-carat'))||1;switch(goldCarat){case 18:{let livePrice_18=livePrice_24*0.75;let calculatedValue1=weight*(manufacturingFees+livePrice_18)*1.15;calculatedValue=color==='#10B981'?calculatedValue1+2:calculatedValue1-2}
break;case 21:{let livePrice_21=livePrice_24*0.875;calculatedValue=weight*(manufacturingFees+livePrice_21)*1.15}
break;case 24:{calculatedValue=livePrice_24*weight}
break;default:console.error('Invalid gold carat value:',goldCarat);break}
...
async function startSession(){console.log('Starting a new session...');return{cst:'newCST123',securityToken:'newToken123',}}
