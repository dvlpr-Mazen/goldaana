...
function renderProductPrice(elements,livePrice_24,calculatedValue,color){elements.forEach((element)=>{const weight=parseFloat(element.getAttribute('data-product-weight'))||1;const manufacturingFees=parseFloat(element.getAttribute('data-product-manufacturing-fees'))||1;const goldCarat=parseInt(element.getAttribute('data-product-gold-carat'));switch(goldCarat){case 18:{const livePrice_18=livePrice_24*0.75;const value_18=weight*(manufacturingFees+livePrice_18)*1.15;calculatedValue=color==='#10B981'?value_18+2:value_18-2;break}
case 21:{const livePrice_21=livePrice_24*0.875;const value_21=weight*(manufacturingFees+livePrice_21)*1.15;calculatedValue=color==='#10B981'?value_21+2:value_21-2;break}
case 24:{calculatedValue=livePrice_24*weight;break}
default:calculatedValue='بيانات ناقصه';console.warn('Invalid gold carat value:',goldCarat);break}
