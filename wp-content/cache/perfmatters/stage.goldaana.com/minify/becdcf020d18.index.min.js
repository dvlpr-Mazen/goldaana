...
function renderProductPrice(elements,livePrice_24,calculatedValue,color){elements.forEach((element)=>{const weight=parseFloat(element.getAttribute('data-product-weight'))||1;const manufacturingFees=parseFloat(element.getAttribute('data-product-manufacturing-fees'))||1;const goldCarat=parseInt(element.getAttribute('data-product-gold-carat'));console.log("Raw gold carat attribute:",element.getAttribute('data-product-gold-carat'));console.log("Element being processed:",element);console.log(goldCarat);switch(goldCarat){case 18:{const livePrice_18=livePrice_24*0.75;const value_18=weight*(manufacturingFees+livePrice_18)*1.15;calculatedValue=color==='#10B981'?value_18+2:value_18-2;break}
...
default:console.warn('Invalid gold carat value:',goldCarat);break}
